...
from src.data.data_stores.acc_entire_rounds import AccEntireRounds
from src.data.data_stores.players_games_and_money_won import PlayersGamesAndMoneyWon
from src.data.filters.player_wins import PlayerWins
...
class E0_0_1(BaseExperiment):
    ...
    def __init__(self):
        ...
        self.data_stores = [PlayersGamesAndMoneyWon([PlayerWins(0)]), AccEntireRounds([PlayerWins(0)])]
